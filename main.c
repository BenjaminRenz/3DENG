...
int main(int argc, char** argv){
    ...
    struct DynamicList* TrianglesOrder=utf32dynlistToInts64_freeArg1(createCharMatchList(2,' ',' '),xmlTrianglesOrderP->content);
    ...
    struct xmlTreeElement* xmlNormalsSourceP=getFirstSubelementWith_freeArg2345(xmlMeshElementP,stringToUTF32Dynlist("source"),
                                                                    stringToUTF32Dynlist("id"),DlCombine_freeArg2(sizeof(uint32_t),meshID,stringToUTF32Dynlist("-normals")),NULL,0);
    struct xmlTreeElement* xmlNormalsFloatP=getFirstSubelementWith_freeArg2345(xmlNormalsSourceP,stringToUTF32Dynlist("float_array"),
                                                                    stringToUTF32Dynlist("id"),DlCombine_freeArg2(sizeof(uint32_t),meshID,stringToUTF32Dynlist("-normals-array")),NULL,0);
    ...
    uint32_t NormalsCount=utf32dynlistToInts64_freeArg1(NormalsCountString,createCharMatchList(2,' ',' '));
    ...
    struct xmlTreeElement* xmlPositionsSourceP=getFirstSubelementWith_freeArg2345(xmlMeshElementP,stringToUTF32Dynlist("source"),
                                                                     stringToUTF32Dynlist("id"),DlCombine_freeArg2(sizeof(uint32_t),meshID,stringToUTF32Dynlist("-positions")),NULL,0);
